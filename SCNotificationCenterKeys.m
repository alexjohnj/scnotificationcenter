...
NSString * const SCNotificationCenterNotificationDescription = @"NotificationDescription";
NSString * const SCNotificationCenterNotificationIcon = @"NotificationIcon";
NSString * const SCNotificationCenterNotificationAppIcon = @"NotificationAppIcon";
